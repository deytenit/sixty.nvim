--[[
sixty.nvim - Disables arrow keys and encourages using a 60% keyboard layout by displaying reminders.

Modules:
  - config.lua: Stores and manages default configurations and custom options.
  - notifications.lua: Contains notification logic for alerting users to use 60% layout.

Example Usage:
  require("sixty").setup({
    notify_timeout = 2000, -- Customize notification timeout in milliseconds
  })
]]
...
--- Configures sixty.nvim using user-defined options or defaults.
