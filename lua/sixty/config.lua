--[[
sixty.nvim Configurations

Handles user configuration for the sixty.nvim plugin, specifically for notification settings.
...
--- Configures sixty.nvim with user-defined options or applies defaults.
